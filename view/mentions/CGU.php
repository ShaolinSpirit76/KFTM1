...
<p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site http://KungFu.ThieuLam.Montivilliers.fr et de ses services.</p>
...
<p>Pour les personnes morales :<br />

Le site http://KungFu.ThieuLam.Montivilliers.fr est édité par la société KUNG FU THIEU-LAM, Association de loi 1901 au capital de 0 €, dont le siège social est situé à Montivilliers (76290).

La société est représentée par Jean-Marie Levray.</p>


<p>Pour les personnes physiques : 

Le site http://KungFu.ThieuLam.Montivilliers.fr est édité par [nom et prénom du responsable], domicilié au [adresse postale].</p>



<h3>ARTICLE 3 : accès aux services</h3>

<p>L’Utilisateur du site http://KungFu.ThieuLam.Montivilliers.fr a accès aux services suivants :<br />
<ul>
        
    <li>Consultation des pages, du calendrier et des divers articles postés par l'administrateur</li>
    <li>Envoyer un message à l'administrateur</li>
...
<ul>
    <li>Modification et suppression de profil</li>
    <li>Gestion de l'affichage du profil dans la page "Mon compte"</li>
    <li>Consultation et téléchargement des archives (vidéos, photos)</li>
    <li>Inscription à des événements du calendrier</li>
    <li>Réservation d'articles disponibles dans la page "Boutique"</li>
    <li>Laisser des commentaires aux articles postés par l'administrateur</li>
    <li>Participation au chat local</li>    
    </ul></p>
...
<p>L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site http://KungFu.ThieuLam.Montivilliers.fr.</p>
...
<p>Le site permet aux membres de publier sur le site :<br />
<ul>
    <li>Commentaires</li>
</ul></p>
...
<p>Le site http://KungFu.ThieuLam.Montivilliers.fr s'engage à mettre en œuvre tous les moyens nécessaires pour garantir la sécurité et la confidentialité des données. Toutefois, il n’apporte pas une garantie de sécurité totale.</p>
...
<p>Les contenus du site http://KungFu.ThieuLam.Montivilliers.fr (logos, textes, éléments graphiques, vidéos, etc.) son protégés par le droit d’auteur, en vertu du Code de la propriété intellectuelle.</p>
...
<p>L’adresse électronique (e-mail) de l’utilisateur pourra notamment être utilisée par le site http://KungFu.ThieuLam.Montivilliers.fr pour la communication d’informations diverses et la gestion du compte.</p>

<p>http://KungFu.ThieuLam.Montivilliers.fr garantie le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.</p>

<p>En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via :<br />
<ul>
    <li>Son espace personnel sur le site </li>
    <li>Un formulaire de contact </li>
    <li>Par mail à kungfu.montivilliers@gmail.com </li>
    <li>Par voie postale au : Kung-Fu Thieulam, rue du Manoir, 76290, Montivilliers</li>
    </ul></p>


<h3>ARTICLE 8 : Liens hypertextes</h3>

<p>Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de http://KungFu.ThieuLam.Montivilliers.fr, qui n’a pas de contrôle sur ces liens.</p>

<p>Il est possible pour un tiers de créer un lien vers une page du site http://KungFu.ThieuLam.Montivilliers.fr sans autorisation expresse de l’éditeur.</p>


<h3>ARTICLE 9 : Évolution des conditions générales d’utilisation</h3>

<p>Le site http://KungFu.ThieuLam.Montivilliers.fr se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.</p>
